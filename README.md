...
Si quieres, puedo:
- Añadir un ejemplo de `partida_ejemplo.motojson`.
- Generar un archivo `CONTRIBUTING.md` con pautas para colaborar.
- Proponer un `CHANGELOG.md` con los cambios recientes que aplicamos.

¿Quieres que reemplace tu README.md con esta versión y que te genere el commit message sugerido?  
